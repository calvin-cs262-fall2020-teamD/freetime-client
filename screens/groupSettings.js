    ...
    if (context.renamed) {
        ...
        return (
            <View style={globalStyles.container}>
                <Button text={"Rename Group"} backgroundColor={"#70cefa"} textColor={"green"}
                        onPress={() => context.renameGroup(route.params.name)}></Button>
                <Button text={"Delete Group"} backgroundColor={"#70cefa"} textColor={"white"}
                        onPress={() => context.deleteGroup(route.params.name, route.params.key, navigation)}></Button>
            </View>
        )
    } else {
        useEffect(() => navigation.setOptions({
            ...
            <TouchableWithoutFeedback onPress={() => {
                ...
                <View style={globalStyles.container}>
                    ...
                    <Button text={"Rename Group"} textColor={'black'} backgroundColor={'#70cefa'}
                            onPress={() => context.renamedGroup(route.params.name, navigation)}></Button>
